...
$rutas = [
    ...
    'publicaciones' => [
        1 => 'usuaria/publicaciones',
        2 => 'usuaria/publicaciones',
        3 => 'admin/'
    ]
];
?>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarEspecialista">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link"
                        href="<?= $urlBase ?>vista/<?= !empty($usuario['id'])
                                                        ? rutaSegura($rutas['libreYSeguro'], $usuario['rol'])
                                                        : 'usuaria/libreYSeguro' ?>">
                        Libre y Seguro
                    </a>
                </li>
                ...
                <?php if (!empty($usuario['id'])): ?>
                    <li class="nav-item">
                        <a class="nav-link"
                            href="<?= $urlBase ?>vista/<?= rutaSegura($rutas['publicaciones'], $usuario['rol']) ?>">
                            Publicaciones
                        </a>
                    </li>
                <?php endif; ?>
                            ...
                            <?php if ($usuario['rol'] <= 1): ?>
                                ...
                                <li>
                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalNotificaciones">
                                        ...
                                        <span id="contadorNotificaciones" class="badge bg-danger rounded-pill ms-2"
                                            style="display: <?= $notificacionesNoLeidas ? 'inline-block' : 'none' ?>;">
                                            <?= $notificacionesNoLeidas ?? 0 ?>
                                        </span>
                                    </a>
                                ...
                                <li>
                                    <form action="<?= $urlBase ?>Controlador/CerrarSesion.php" method="post" class="m-0 p-0">
