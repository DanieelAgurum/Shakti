...
<div class="modal fade custom-config-modal" id="notaModal<?= $index ?>" tabindex="-1" aria-labelledby="notaModalLabel<?= $index ?>" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-banner-eliminar" data-bs-target="#eliminarNotaModal<?= $index ?>" data-bs-toggle="modal" data-bs-dismiss="modal">
                    <i class="bi bi-x-lg"></i> Eliminar
                </button>
                <button class="btn btn-banner" data-bs-target="#editarNotaModal<?= $index ?>" data-bs-toggle="modal" data-bs-dismiss="modal">
...
<div class="modal fade custom-config-modal" id="editarNotaModal<?= $index ?>" tabindex="-1" aria-labelledby="editarNotaModalLabel<?= $index ?>" aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="../../Controlador/notasCtrl.php" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-banner"><i class="bi bi-check2-circle"></i> Guardar</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade custom-config-modal" id="eliminarNotaModal<?= $index ?>" tabindex="-1" aria-labelledby="editarNotaModalLabel<?= $index ?>" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="../../Controlador/notasCtrl.php" method="post">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-banner btn-secondary" data-bs-dismiss="modal"><i class="bi bi-x-lg"></i> Cancelar</button>
                    <button type="submit" class="btn btn-banner-eliminar"><i class="bi bi-eraser-fill"></i> Confirmar</button>
                </div>
            </form>
        </div>
    </div>
